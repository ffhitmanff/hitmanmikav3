            ...
            if (isOwnerBot) {
                await dxxoo.joinGroupViaLink(linkgrup)
                      .then(async () => {
                          ...
                          await dxxoo.sendText(chekgrup.id, `Hai minna~, Im HITMAN-MIKA Bot. To find out the commands on this Bot type ${prefix}menu`)
                      })
            } else {
    ...
    case 'dare':
        ...
        case 'bc': //untuk broadcast atau promosi
            ...
            for (let idk of chatz) {
                ...
                if (!cvk.isReadOnly) dxxoo.sendText(idk, `* HITMAN-MIKA BC *\n\n${msg}`)
                if (cvk.isReadOnly) dxxoo.sendText(idk, `* HITMAN-MIKA BC *\n\n${msg}`)
            }
