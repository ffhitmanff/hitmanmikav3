...
Untuk menggunakan bot silahkan kirim ${prefix}menu`)
            ...
            case 'leveling':
                ...
                if (args[0] === 'enable') {
                    ...
                    await dxxoo.reply(from, `Untuk mengaktifkan Fitur Level pada Group Chat\n\nPenggunaan\n${prefix}leveling enable --mengaktifkan\n${prefix}leveling disable --nonaktifkan\n`, id)
                }
            break			
	...
	//Sticker Converter
       ...
       case 'emojisticker':
            ...
            dxxoo.sendStickerfromUrl(from, `https://api.vhtear.com/emojitopng?code=${emoji}&apikey=Jsieu8287362jshre82`)
             .catch ((err) => {
                console.log(err)
	...
	case 'stimg':
            if (quotedMsg && quotedMsg.type == 'sticker') {
                ...
                await dxxoo.sendFile(from, imageBase64, 'imgsticker.jpg', 'Succes convert Sticker to Image!', id)
                .then(() => {
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Mascot Giming\nPemakaian: ${prefix}mascotlogo [teks]\n\ncontoh: ${prefix}mascotlogo Dimas`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/gamelogo?text=${lmascotlogo}&apikey=Jsieu8287362jshre82`, '', 'Nih...', id)
    ...
    case 'logoml':
            ...
            if (argz.length >= 2) {
                ...
                dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/logoml?hero=${lheroml}&text=${llogoml}&apikey=Jsieu8287362jshre82`)
            } else {
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text Gambar Hartatahta\nPemakaian: ${prefix}hartatahta [teks]\n\ncontoh: ${prefix}hartatahta Dimas`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/hartatahta?text=${lhartatahta}&apikey=Jsieu8287362jshre82`, '', 'Nih...', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text Gambar thunder\nPemakaian: ${prefix}thundertext [teks]\n\ncontoh: ${prefix}thundertext Dimas`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/thundertext?text=${lthundertext}&apikey=Jsieu8287362jshre82`, '', 'Nih...', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text Sliding\nPemakaian: ${prefix}slidingtext [teks]\n\ncontoh: ${prefix}slidingtext Dimas`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/slidingtext?text=${lslidingtext}&apikey=Jsieu8287362jshre82`, '', 'neh....', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text jadi Gambar lovemessage\nPemakaian: ${prefix}lovemessagetext [teks]\n\ncontoh: ${prefix}lovemessagetext Dimas D`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/lovemessagetext?text=${llovemessagetext}&apikey=Jsieu8287362jshre82`, '', 'Nih...', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text jadi Gambar ala ala glow gitu\nPemakaian: ${prefix}glowtext [teks]\n\ncontoh: ${prefix}glowtext Dimas D`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/glowtext?text=${lglowtext}&apikey=Jsieu8287362jshre82`, '', 'Nih...', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text jadi Gambar ala ala romance\nPemakaian: ${prefix}romancetext [teks]\n\ncontoh: ${prefix}romancetext Dimas dan Ujang`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/romancetext?text=${lpartytext}&apikey=Jsieu8287362jshre82`, '', 'Nih...', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text jadi Gambar Nature\nPemakaian: ${prefix}textmaker [teks]\n\ncontoh: ${prefix}textmaker Dimas`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/silktext?text=${lsilktext}&apikey=Jsieu8287362jshre82`, '', 'Nih...', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text jadi Gambar ala ala party\nPemakaian: ${prefix}partytext [teks]\n\ncontoh: ${prefix}partytext Dimas`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/partytext?text=${llpartytext}&apikey=Jsieu8287362jshre82`, '', 'Nih...', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
        ...
        case 'stiker':
            ...
            case 'antistiker':
                    ...
                    if (args[0] == 'enable') {
                        ...
                        dxxoo.reply(from, `pilih enable atau disable udin!\n\n*[Anti Group Link]*\nSetiap member grup yang mengirim pesan mengandung link grup akan di kick oleh bot!`, id)
                    }
                    break  
    case 'stickertext':
    if (args.length == 0) return dxxoo.reply(from, `Membuat Sticker Text\nPemakaian: ${prefix}stickertext [teks]\n\ncontoh: ${prefix}stickertext Dimas`, id)
                ...
                await dxxoo.sendStickerfromUrl(from, `https://api.vhtear.com/textxgif?text=${ltextxgif}&apikey=Jsieu8287362jshre82`)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
        ...
        case 'stikergif':
            if (isMedia || isQuotedVideo) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    var mediaData = await decryptMedia(message, uaOverride)
                    dxxoo.reply(from, '[ WAIT ] Sedang di proses silahkan tunggu sebentar!', id)
        ...
        case 'stickergiphy':
            ...
            if (isGiphy) {
                ...
                .catch(() => {
                    dxxoo.reply(from, `[] Terjadi kesalahan, mungkin error di sebabkan oleh sistem.`, id)
                })
            } else {
        ...
        case 'meme':
            if ((isMedia || isQuotedImage) && args.length >= 2) {
                ...
                dxxoo.sendFile(from, ImageBase64, 'image.png', '', null, true)
                    ...
                    .catch(() => {
                        dxxoo.reply(from, '[] Terjadi kesalahan, mungkin error di sebabkan oleh sistem.')
                    })
            } else {
        ...
        case 'quotemaker':
            ...
            if (qmaker.length >= 3) {
                ...
                try {
                    ...
                    dxxoo.reply('[] Terjadi Kesalahan Mungkin Di Sebab Kan Oleh Sistem.', id)
                }
            } else {
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text Sliding\nPemakaian: ${prefix}nulis2 [teks]\n\ncontoh: ${prefix}nulis2 Dimas`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/write?text=${nulis2q}&apikey=Jsieu8287362jshre82`, '', 'nih pemalas....', id)
                    .then(() => console.log('Success creting image!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
    ...
    //Education
        case 'wiki':
            ...
            .catch(() => {
                dxxoo.reply(from, 'Hayolohhh, [] Terjadi kesalahan, mungkin error di sebabkan oleh sistem.!', id)
            })
            break
        case 'kbbi':
    ...
    case 'brainly':
            ...
            if (args.length >= 2){
                ...
                dxxoo.sendText(from, 'Nyontek Tros Males Mikir ?')
                        } else {
	...
	case 'dewabatch':
        ...
        try {
            const datamobill = await axios.get (`https://api.vhtear.com/infomobil?merk=${mobill}&apikey=Jsieu8287362jshre82`)
...
if (!isGroupMsg) return dxxoo.reply(from, `Perintah ini hanya bisa di gunakan dalam group!`, id)
        ...
        dxxoo.reply(from, 'Sabar cin lagi aq carii....\n\nKalo Kaga Muncul Ada yang salah', id)
        try {
            const datamotoy = await axios.get (`https://api.vhtear.com/infomotor?merk=${motoy}&apikey=Jsieu8287362jshre82`)
